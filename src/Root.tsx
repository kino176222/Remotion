...
import '@remotion/google-fonts/DotGothic16'; // Load Pixel Font
import '@remotion/google-fonts/ZenDots'; // Load Sci-Fi Font
...
[02:39.210] イマ {vertical:true, size:800, flash:3, exit:scatter}
[02:41.160]
`;
    ...
    return (
        <>
            ...
            <Composition
                ...
                durationInFrames={30 * 185} // 3m 05s (Buffer added)
                fps={30}
                width={1920}
                height={1080}
                ...
                defaultProps={{
                    ...
                    lrcSrc: staticFile('2025_12_11 5_47_01.lrc'),
                    lrcContent: INITIAL_LRC,
                    videoSrc: staticFile('銀のゆりかご.mp4'),
